...
class _FoodPageBodyState extends State<FoodPageBody> {
  ...
  void initState() {
    ...
    pageController.addListener(() {
      setState(() {
        _currPageValue =
            pageController.page!; //.page is the page value! is null checker
                    ...
                    child: Container(
                        ...
                        child: Padding(
                            ...
                            child: Column(
                                ...
                                children: [
                                  BigText(
                                      text: 'Nutritious, spicy meal in Ghana'),
                                  SizedBox(
                                    height: Dimensions.height10,
                                  ),
                                  SmallText(
                                      text:
                                          'Spiced with natural spices and herbs'),
                                  SizedBox(
                                    height: Dimensions.height10,
                                  ),
                                  Row(
